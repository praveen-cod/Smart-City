...
class IssueDetailsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final issue = ref.watch(issueByIdProvider(issueId));
                ...
                background: Container(
                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        right: -20, bottom: -20,
                        child: Icon(cat.icon, size: 140, color: Colors.white.withOpacity(0.1)),
                      ),
                      Positioned(
                        left: 16, bottom: 16,
                        child: Column(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(cat.name, style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w600)),
                                ],
                              ),
                            ),
                          ],
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Meta row
                  _MetaRow(icon: Icons.location_on_rounded, text: issue.location.displayName),
                  const SizedBox(height: 6),
                  _MetaRow(icon: Icons.calendar_today_rounded, text: dateStr),
                  _MetaRow(icon: Icons.person_rounded, text: 'Reported by ${issue.reporterName}'),
                  ...
                  Text(
                    issue.description,
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(height: 1.6, color: scheme.onSurfaceVariant),
                  ),
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, i) => Container(
                          ...
                          child: Icon(Icons.image_rounded, color: cat.color, size: 36),
                        ),
                      ),
                    ),
                  ...
                  Text('Status Timeline', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
                  const SizedBox(height: 16),
